  ...
  function () {
      ...
      let n = "string" == typeof e ? e : e.source,
        r = {
          replace: (e, t) => {
            ...
            return ((s = s.replace(f.caret, "$1")), (n = n.replace(e, s)), r);
          },
    ...
    var d = ((e = "") => {
      ...
      f = {
        ...
        fencesBeginRegex: g((e) => new RegExp(`^ {0,${e}}(?:\`\`\`|~~~)`)),
        headingBeginRegex: g((e) => new RegExp(`^ {0,${e}}#`)),
        htmlBeginRegex: g(
          (e) => new RegExp(`^ {0,${e}}<(?:[a-z].*>|!--)`, "i"),
        ),
        blockquoteBeginRegex: g((e) => new RegExp(`^ {0,${e}}>`)),
      },
      x = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,
      b = / {0,3}(?:[*+-]|\d{1,9}[.)])/,
      w =
      ...
      Z = /[^\s\p{P}\p{S}]/u,
      D = k(/^((?![*_])punctSpace)/, "u")
        .replace(/punctSpace/g, v)
        .getRegex(),
      O = /(?!~)[\p{P}\p{S}]/u,
      j = k(/link|precode-code|html/, "g")
        .replace(
          "link",
          /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/,
        )
        ...
        .replace("html", /<(?! )[^<>]*?>/)
        .getRegex(),
      Q = /^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,
      M = k(Q, "u").replace(/punct/g, q).getRegex(),
      H = k(Q, "u").replace(/punct/g, O).getRegex(),
      N =
      ...
      K = k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
        ...
        .getRegex(),
      V = k(A).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
      Y = k(
      ...
      ce = { normal: L, gfm: E, pedantic: C },
      he = { normal: le, gfm: ae, breaks: oe, pedantic: ie },
      pe = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    function ge(e, t) {
      if (t) {
        if (f.escapeTest.test(e)) return e.replace(f.escapeReplace, ue);
      } else if (f.escapeTestNoEncode.test(e))
        return e.replace(f.escapeReplaceNoEncode, ue);
      return e;
    }
    function ke(e) {
      try {
    ...
    var me = class {
        ...
        code(e) {
          ...
          if (t) {
            let e = this.options.pedantic ? t[0] : xe(t[0]),
            ...
            for (; e.length > 0; ) {
              ...
              if ("blockquote" === h?.type) {
                let t = h,
                  ...
                  i = this.blockquote(l);
                ((s[s.length - 1] = i),
                  (n = n.substring(0, n.length - t.raw.length) + i.raw),
                  (r = r.substring(0, r.length - t.text.length) + i.text));
                break;
              }
              if ("list" === h?.type) {
                let t = h,
                  ...
                  i = this.list(l);
                ((s[s.length - 1] = i),
                  (n = n.substring(0, n.length - h.raw.length) + i.raw),
                  (r = r.substring(0, r.length - t.raw.length) + i.raw),
                  (e = l.substring(s.at(-1).raw.length).split("\n")));
                continue;
              }
            }
        ...
        list(e) {
          ...
          if (t) {
            ...
            for (; e; ) {
              ...
              if (
                (this.options.pedantic
                  ...
                  : h
                    ? (p = t[1].length + 1)
                    : ((p = o.search(this.rules.other.nonSpaceChar)),
                      (p = p > 4 ? 1 : p),
                      (a = o.slice(p)),
                      (p += t[1].length)),
                h &&
                ...
                let t = this.rules.other.nextBulletRegex(p),
                  n = this.rules.other.hrRegex(p),
                  s = this.rules.other.fencesBeginRegex(p),
                  l = this.rules.other.headingBeginRegex(p),
                  i = this.rules.other.htmlBeginRegex(p),
                  u = this.rules.other.blockquoteBeginRegex(p);
                for (; e; ) {
                  let g,
                    k = e.split("\n", 1)[0];
                  if (
              ...
              (s.loose ||
                (i
                  ? (s.loose = !0)
                  : this.rules.other.doubleBlankLine.test(r) && (i = !0)),
                s.items.push({
                  type: "list_item",
                  raw: r,
                  task:
            ...
            for (let e of s.items) {
              ...
              let t = e.tokens[0];
              if (!e.task || ("text" !== t?.type && "paragraph" !== t?.type))
                e.task && (e.task = !1);
              else {
        ...
        emStrong(e, t, n = "") {
          ...
          if (
            ...
            for (
              o.lastIndex = 0, t = t.slice(-1 * e.length + l);
              null !== (r = o.exec(t));
            ) {
        ...
        del(e, t, n = "") {
          ...
          if (r && (!r[1] || !n || this.rules.inline.punctuation.exec(n))) {
            ...
            for (
              a.lastIndex = 0, t = t.slice(-1 * e.length + l);
              null !== (r = a.exec(t));
            ) {
              if (
      ...
      ye = class e {
        ...
        constructor(e) {
          ((this.tokens = []),
            ...
            (this.options = e || h),
            (this.options.tokenizer = this.options.tokenizer || new me()),
            (this.tokenizer = this.options.tokenizer),
            (this.tokenizer.options = this.options),
            (this.tokenizer.lexer = this),
            (this.inlineQueue = []),
            (this.state = { inLink: !1, inRawBlock: !1, top: !0 }));
          let t = { other: f, block: ce.normal, inline: he.normal };
          (this.options.pedantic
            ? ((t.block = ce.pedantic), (t.inline = he.pedantic))
            : this.options.gfm &&
              ((t.block = ce.gfm),
              this.options.breaks
                ? (t.inline = he.breaks)
        ...
        inlineTokens(e, t = []) {
          ...
          for (; e; ) {
            ...
            if ((n = this.tokenizer.emStrong(e, r, i))) {
              ((e = e.substring(n.raw.length)), t.push(n));
              continue;
            }
      ...
      $e = class {
        ...
        image({ href: e, title: t, text: n, tokens: r }) {
          ...
          let s = ke(e);
          if (null === s) return ge(n);
          let l = `<img src="${(e = s)}" alt="${ge(n)}"`;
          return (t && (l += ` title="${ge(t)}"`), (l += ">"), l);
        }
        text(e) {
      ...
      Se = class e {
        ...
        constructor(e) {
          ((this.options = e || h),
            (this.options.renderer = this.options.renderer || new $e()),
      ...
      Te = class {
        ...
        provideLexer(e = this.block) {
          return e ? ye.lex : ye.lexInline;
        }
        provideParser(e = this.block) {
          return e ? Se.parse : Se.parseInline;
        }
      },
      ze = class {
        defaults = {
        ...
        use(...e) {
          ...
          return (
            e.forEach((e) => {
              ...
              if (e.tokenizer) {
                let t = this.defaults.tokenizer || new me(this.defaults);
                ...
                for (let n in e.hooks) {
                  ...
                  Te.passThroughHooks.has(n)
                    ? (t[r] = (e) => {
                        if (
                          this.defaults.async &&
                          Te.passThroughHooksRespectAsync.has(n)
                        )
                          return (async () => {
            ...
            if (
              ...
              return (async () => {
                let n = s.hooks ? await s.hooks.preprocess(t) : t,
                  ...
                  l = s.hooks ? await s.hooks.processAllTokens(r) : r;
                s.walkTokens &&
                  (await Promise.all(this.walkTokens(l, s.walkTokens)));
                let i = await (
                  s.hooks
                ...
                return s.hooks ? await s.hooks.postprocess(i) : i;
              })().catch(l);
            try {
              s.hooks && (t = s.hooks.preprocess(t));
              let n = (
                s.hooks ? s.hooks.provideLexer(e) : e ? ye.lex : ye.lexInline
              )(t, s);
    ...
    ((_e.options = _e.setOptions =
      ...
      (_e.defaults = h),
      (_e.use = function (...e) {
        return (Ae.use(...e), (_e.defaults = Ae.defaults), p(_e.defaults), _e);
      }),
      (_e.walkTokens = function (e, t) {
        return Ae.walkTokens(e, t);
      }),
      (_e.parseInline = Ae.parseInline),
      (_e.Parser = Se),
      (_e.parser = Se.parse),
      (_e.Renderer = $e),
      (_e.TextRenderer = Re),
    ...
    var Pe = _e.options,
      ...
      qe = Se.parse,
      ve = ye.lex;
    return (n != t && (r.exports = t), r.exports);
  },
);
